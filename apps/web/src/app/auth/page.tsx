...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      {/* Left Panel - Branding */}
      <div className="hidden lg:flex lg:flex-1 bg-gradient-to-br from-primary/10 via-background to-accent/10 relative overflow-hidden">
        <div className="absolute inset-0 bg-grid-white/5 [mask-image:linear-gradient(0deg,white,rgba(255,255,255,0.6))]" />
        <div className="relative flex flex-col justify-center px-12 py-24">
          <div className="max-w-md">
            <h1 className="text-4xl font-bold text-foreground mb-6">
              Welcome to Gamestash
            </h1>
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              Discover premium digital products, templates, and resources from
              talented creators worldwide.
            </p>
            <div className="space-y-4 text-sm text-muted-foreground">
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-primary rounded-full" />
                <span>Thousands of high-quality digital products</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-primary rounded-full" />
                <span>Secure payments and instant downloads</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-primary rounded-full" />
      ...
      <div className="flex-1 lg:max-w-md xl:max-w-lg flex flex-col justify-center px-6 py-12 lg:px-12">
        {/* Back Button */}
        <div className="mb-8">
          <Link href="/">
            <Button
        ...
        <div className="w-full max-w-sm mx-auto lg:mx-0">
          ...
          {/* Mobile Branding */}
          <div className="lg:hidden mt-12 pt-8 border-t text-center">
